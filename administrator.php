...
if (!isset($_SESSION['Employee_Email']) || $_SESSION['Employee_kind'] !== 'Admin') {
...
<body>
  ...
  <section class="mainbody2">
    ...
    <div class="box-1">
      ...
      <a href="employee.php"><input type="button" value="EMPLOYEE PORTAL"></a>
      <br>
      <a href="project.php"><input type="button" value=" PROJECT PORTAL"></a>
      <br>
